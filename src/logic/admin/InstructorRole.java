...
public class InstructorRole {
    ...
    private final JsonCoursesReader coursesReader;
    private final JsonUserReader userReader;
    ...
    public InstructorRole() {
        this.coursesReader = new JsonCoursesReader(COURSES_FILE);
        this.userReader = new JsonUserReader(USERS_FILE);
    }
