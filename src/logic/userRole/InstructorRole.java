...
public class InstructorRole {
    ...
    private final JsonCourses coursesReader;
    private final JsonUsers userReader;
    ...
    public InstructorRole() {
        this.coursesReader = new JsonCourses(COURSES_FILE);
        this.userReader = new JsonUsers(USERS_FILE);
    }
